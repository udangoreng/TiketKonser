...
public class ManageOrderInterface extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ManageOrderInterface frame = new ManageOrderInterface();
	...
	public ManageOrderInterface() {
		...
		lblNewLabel_3.setBounds(36, 175, 168, 40);
		...
		lblNewLabel_3_1.setBounds(36, 216, 168, 40);
		...
		lblNewLabel_4.setBounds(36, 134, 124, 30);
		...
		JLabel lblNewLabel_2 = new JLabel("Manage Order");
		lblNewLabel_2.setForeground(Color.WHITE);
		lblNewLabel_2.setFont(new Font("Poppins", Font.BOLD, 18));
		lblNewLabel_2.setBounds(302, 38, 227, 39);
		contentPane.add(lblNewLabel_2);
		
		String[] columnNames = {"No", "Order ID", "Tiket ID", "Konser", "User", "Aksi"};
